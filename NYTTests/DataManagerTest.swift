...
class DataManagerTest: XCTestCase {
    ...
    func testSearchDownload(){
        ...
        let dm = DataManager(httpManager: MockHTTPManagerSearch.shared)
    ...
    func testContentDownload(){
        let expectation = XCTestExpectation(description: #function)
        let dm = DataManager(httpManager: MockHTTPManager.shared)
    ...
    func testImageDownload(){
        let expectation = XCTestExpectation(description: #function)
        let dm = DataManager(httpManager: MockHTTPManagerImage.shared)
